...
| `user_profile_updated`                                                            | Authenticated user                                            | user                      | Required             | Changed field names only                                             | `users.integration`                                                    |
...
| `upload_authorized`                                                               | Authenticated user                                            | upload authorization      | Best effort          | Content type and size category                                       | `uploads.integration`                                                  |
